...
const { Server } = require("../projectcNoZoom/node_modules/socket.io/dist");
...
// let archive = rooms.findIndex(room=>{
...
//method1:
  ...
  let data;
    ...
    socket.on('disconnect', () => {
        ...
        // for(i=rooms[roomIdx].members.length; i >= 1; i--){
        //   if( rooms[roomIdx].members[i] != rooms[roomIdx].parts.lefteye.id){
        //     console.log("lefteye")
        //    rooms[roomIdx].parts.lefteye.id = '';
        //   } else if(rooms[roomIdx].members[i] != rooms[roomIdx].parts.righteye.id){
        //     console.log("righteye")
        //    rooms[roomIdx].parts.righteye.id = '';
        //   }else if(rooms[roomIdx].members[i] != rooms[roomIdx].parts.mouth.id){
        //     console.log("mouth")
        //    rooms[roomIdx].parts.mouth.id = '';
        //   }else if(rooms[roomIdx].members[i] != rooms[roomIdx].parts.forehead.id){
        //     console.log("forehead")
        //    rooms[roomIdx].parts.forehead.id = '';
        //   }else if(rooms[roomIdx].members[i] != rooms[roomIdx].parts.nose.id){
        //     console.log("nose")
