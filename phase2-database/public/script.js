...
btn.addEventListener("click", ()=>{
  ...
  if (confirm("Can I collect your face data?")) {
    takePhoto();
    store = imgData;
    if(imgData === undefined){
      console.log("hiahsiskbc轻松点");
      alert("Didn't recognise your face😞 Could you contribute again?")
    }else{
